...
\title{Edition der\\Archivhefte der Technischen Abteilung\\(Arbeiten der älteren Serie, AeS)}
\date{\today}
...
Bei den \glqq Archiv-Heften der technischen Abteilung\grqq{} handelt es sich um eine Sammlung technisch und historisch interessanter Dokumente des öster\-reichi\-schen Eichwesens. Gegründet wurde sie durch die Normal-Eichungs-Komm\-iss\-ions (kurz NEK, vor 1900 NAC). Diese Sammlung umfasst einen Zeitraum von etwa 1867 (also vor Gründung der NEK) bis 1883. Inhaltlich findet man Protokolle von Etalonierungen der Hauptnormale, Prüfungsscheine ausländischer Institute, Protokolle außergewöhnlicher Messungen, grundlegende Vorschriften und Ähnliches.

Im Gegensatz zu den weit umfangreicheren Archivheften der \glqq Neuen Serie\grqq{} wurden hier interessante Dokumente zusammengestellt, die aus unterschiedlichen Gründen dort keine Aufnahme finden konnten. Beinahe alle hier angeführten Hefte tragen mit roter Tinte verfasste Kommentare von Wenzel Marek
...
Mit der \glqq Technischen Abteilung\grqq{} ist ursprünglich eine Organisationseinheit der NEK gemeint. Am ehesten kann die heutige (2023) Abteilung E2 des BEV damit verglichen werden.
...
Die Daten sind in der Text-Datei \texttt{AH\_AeS.txt} archiviert. Diese wird zu einer XML-Datei \texttt{AH\_AeS.xml} und diese wiederum zu \texttt{AH\_AeS.tex} umgewandelt. Die Daten und entsprechenden Programme sind auf GitHub hinterlegt (\texttt{https://github.com/matusm/ArchivHefte}).
